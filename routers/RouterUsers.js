...
user.get("/pag_principal.html",middlewareLogin, ControllerUsuario.pag_principal);
...
user.get("/usuarios.html",middlewareLogin, ControllerUsuario.usuarios);
...
user.get("/perfil_usu/:idUsuario",middlewareLogin, ControllerUsuario.perfil_usu);
